...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/iannil/code-coder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for iannil/code-coder...\n")
...
console.log("Fetching npm all-time downloads for codecoder-ai...\n")
const npmDownloads = await fetchNpmDownloads("codecoder-ai")
