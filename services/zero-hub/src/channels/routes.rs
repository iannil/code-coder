    ...
    if let Some(msg) = update.message {
        if let Some(text) = msg.text {
            ...
            let channel_msg = ChannelMessage {
                ...
                channel_type: crate::channels::message::ChannelType::Telegram,
                channel_id: msg.chat.id.to_string(),
                user_id,
                content: crate::channels::message::MessageContent::Text { text },
                attachments: vec![],
...
async fn generic_webhook(
    ...
    let channel_type = match payload.channel.to_lowercase().as_str() {
        "telegram" => crate::channels::message::ChannelType::Telegram,
        "discord" => crate::channels::message::ChannelType::Discord,
        "slack" => crate::channels::message::ChannelType::Slack,
        "feishu" => crate::channels::message::ChannelType::Feishu,
        "wecom" => crate::channels::message::ChannelType::WeCom,
        "dingtalk" => crate::channels::message::ChannelType::DingTalk,
        "whatsapp" => crate::channels::message::ChannelType::WhatsApp,
        "matrix" => crate::channels::message::ChannelType::Matrix,
        "imessage" => crate::channels::message::ChannelType::IMessage,
        "email" => crate::channels::message::ChannelType::Email,
        _ => crate::channels::message::ChannelType::Cli,
    };
...
struct CaptureResponse {
    success: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    data: Option<crate::channels::capture_bridge::CapturedAsset>,
    #[serde(skip_serializing_if = "Option::is_none")]
    error: Option<String>,
}
...
struct HistoryResponse {
    success: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    data: Option<Vec<crate::channels::capture_bridge::CapturedAsset>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    total: Option<usize>,
    #[serde(skip_serializing_if = "Option::is_none")]
    error: Option<String>,
...
struct SaveResponse {
    success: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    data: Option<crate::channels::capture_bridge::SavedLocation>,
    #[serde(skip_serializing_if = "Option::is_none")]
    error: Option<String>,
}
...
mod tests {
    ...
    async fn test_generic_webhook() {
        ...
        if let crate::channels::message::MessageContent::Text { text } = msg.content {
