...
use super::auth::{auth_middleware, AuthState, AuthUser};
use super::metering::{MeteringState, UsageReport};
use super::parallel::{ParallelState, parallel_routes};
use super::provider::create_registry;
use super::proxy::{proxy_request, ProxyState};
use super::quota::QuotaLimits;
use super::sandbox::{AuditAction, AuditEntry, DayCount, Sandbox, SandboxConfig};
use super::user::{CreateUserRequest, UpdateUserRequest, User, UserStore};
use axum::{
...
pub fn build_all_routes_with_db(config: &Config, db_path: Option<PathBuf>) -> Router {
    ...
    let proxy_routes = Router::new()
        ...
        .layer(middleware::from_fn_with_state(
            metering.clone(),
            crate::gateway::metering::metering_middleware,
        ))
        .layer(middleware::from_fn_with_state(
            auth_state.clone(),
            auth_middleware,
