...
use super::provider::{ChatRequest, ChatResponse, ProviderError, ProviderRegistry};
use axum::{
    extract::State,
    http::StatusCode,
            ...
            (
                ...
                ChatRequest {
                    ...
                    messages: request
                        .messages
                        .iter()
                        .map(|m| crate::gateway::provider::Message {
                            role: m.role.clone(),
...
mod tests {
    ...
    fn test_parallel_state_creation() {
        use crate::gateway::provider::ProviderRegistry;
