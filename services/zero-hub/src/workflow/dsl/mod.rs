...
pub enum ControlFlow {
    ...
    If {
        ...
        then_steps: Vec<super::Step>,
        /// Steps to execute if condition is false
        #[serde(default)]
        else_steps: Vec<super::Step>,
    },
    ...
    TryCatch {
        /// Steps to try
        try_steps: Vec<super::Step>,
        /// Steps to execute on error
        catch_steps: Vec<super::Step>,
        /// Steps to always execute
        #[serde(default)]
        finally_steps: Vec<super::Step>,
    },
}
