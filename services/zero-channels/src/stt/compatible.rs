...
//! including local services like faster-whisper-server.
...
mod tests {
    ...
    fn creates_with_default_model() {
        let stt = CompatibleStt::new("sk-test".to_string(), "https://api.example.com", None);
    ...
    fn provider_name() {
        let stt = CompatibleStt::new("sk-test".to_string(), "https://api.example.com", None);
        assert_eq!(stt.provider_name(), "compatible");
    }
}
