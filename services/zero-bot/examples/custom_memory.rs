//! Example: Implementing a custom Memory backend for ZeroBot
//!
...
// ── Re-define the trait types (in your app, import from zero_bot::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 ZeroBot Memory Demo — InMemoryBackend\n");
