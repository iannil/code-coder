...
mod tests {
    ...
    fn format_conversion() {
        ...
        assert_eq!(OpenAiTts::format_to_response_format(AudioFormat::Opus), "opus");
        assert_eq!(OpenAiTts::format_to_response_format(AudioFormat::Flac), "flac");
        // OGG falls back to Opus
        assert_eq!(OpenAiTts::format_to_response_format(AudioFormat::Ogg), "opus");
    }
