//! Utility functions for `Zero CLI`.
//!
...
/// # Examples
/// ```
/// use zero_cli::util::truncate_with_ellipsis;
///
...
/// // Note: ZWJ emoji like 🐦‍🔥 are 3 code points (bird + ZWJ + fire)
/// assert_eq!(truncate_with_ellipsis("Hello 🐦‍🔥 World", 9), "Hello 🐦‍🔥...");
...
mod tests {
    ...
    fn test_truncate_emoji_single() {
        // ZWJ emoji 🐦‍🔥 = 3 code points (bird + ZWJ + fire)
        let s = "🐦‍🔥";
        assert_eq!(truncate_with_ellipsis(s, 10), s); // plenty of room
        assert_eq!(truncate_with_ellipsis(s, 3), s); // exactly 3 code points
        assert_eq!(truncate_with_ellipsis(s, 1), "🐦..."); // only first code point
    }
    ...
    fn test_truncate_mixed_ascii_emoji() {
        ...
        // "Hello 🐦‍🔥 World" = 15 code points: H,e,l,l,o,space,🐦,ZWJ,🔥,space,W,o,r,l,d
        assert_eq!(truncate_with_ellipsis("Hello 🐦‍🔥 World", 9), "Hello 🐦‍🔥...");
