...
export declare class MarkdownMemoryHandle {
  /** Create a new markdown memory store */
  constructor(basePath: string, projectId: string)
  /** Get the configuration */
  config(): NapiMarkdownMemoryConfig
  /** Append a new entry to today's daily notes */
  appendDailyNote(entryType: NapiDailyEntryType, content: string, metadata?: string | undefined | null): void
  /** Get content from today's daily notes */
  getTodayNotes(): string
  /** Load daily notes for a date range (starting from today, going back N days) */
  loadRecentDailyNotes(days: number): Array<string>
  /** List all available daily note dates */
  listDailyNoteDates(): Array<string>
  /** Load entire long-term memory file */
  loadLongTermMemory(): string
  /** Load specific category from long-term memory */
  loadCategory(category: NapiMemoryCategory): string
  /** Update or create a category in long-term memory */
  updateCategory(category: NapiMemoryCategory, content: string): void
  /** Merge new content into existing category */
  mergeToCategory(category: NapiMemoryCategory, update: string): void
  /** Get all memory sections */
  getMemorySections(): Array<NapiMemorySection>
  /** Add item to a category list */
  addListItem(category: NapiMemoryCategory, item: string, subtext?: string | undefined | null): void
  /** Remove item from a category */
  removeListItem(category: NapiMemoryCategory, itemPattern: string): void
  /** Load combined memory context */
  loadContext(includeDays: number): NapiMemoryContext
}
...
export declare class SemanticGraphHandle {
  ...
  /** Add a class */
  addClass(name: string, file: string, extendsClass: string | undefined | null, methods: Array<string>): NapiSemanticNode
  /** Add an interface */
  addInterface(name: string, file: string, extendsInterface?: string | undefined | null): NapiSemanticNode
  /** Add a file */
...
/** Create a new markdown memory store */
export declare export declare function createMarkdownMemory(basePath: string, projectId: string): MarkdownMemoryHandle
...
export declare export declare function createSafetyGuard(sessionId: string, budget?: NapiResourceBudget | undefined | null): SafetyGuardHandle

/** Create new safety guardrails */
export declare export declare function createSafetyGuardrails(sessionId: string, config?: NapiGuardrailConfig | undefined | null): SafetyGuardrailsHandle
...
export declare export declare function evaluateClose(input: NapiCloseInput, weights?: NapiCloseWeights | undefined | null): NapiCloseEvaluation
...
export declare export declare function getRemoteRiskLevel(tool: string): RemoteRiskLevel
...
export declare export declare function isRemoteDangerous(tool: string): boolean

/** Check if a tool is safe for remote access (stateless) */
export declare export declare function isRemoteSafe(tool: string): boolean
...
export interface NapiCloseInput {
  ...
  recentTrendAvg?: number
  olderTrendAvg?: number
}
...
export interface NapiDailyEntry {
  /** ISO 8601 timestamp */
  timestamp: string
  /** Entry type */
  entryType: string
...
export declare const enum NapiDailyEntryType {
  Decision = 'Decision',
  Action = 'Action',
  Output = 'Output',
  Error = 'Error',
...
export interface NapiMarkdownMemoryConfig {
...
export declare const enum NapiMemoryCategory {
...
export interface NapiMemoryContext {
...
export interface NapiMemorySection {
...
/** Tool result */
export declare const enum NapiToolResult {
  Success = 'Success',
  Error = 'Error'
}
...
export declare const enum RemoteRiskLevel {
  Safe = 'Safe',
  Moderate = 'Moderate',
  Dangerous = 'Dangerous'
}
...
export declare export declare function shouldRequireRemoteApproval(tool: string, source: string, userId: string): boolean
