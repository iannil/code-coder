...
/* Synced from services/zero-core/index.d.ts on 2026-03-07 */
...
export declare class CausalGraphHandle {
  ...
  findPatterns(agentId?: string | undefined | null, minOccurrences?: number | undefined | null, limit?: number | undefined | null): NapiCausalPattern[]
  /** Find decisions similar to the given prompt */
  findSimilarDecisions(prompt: string, agentId: string, limit?: number | undefined | null): NapiSimilarDecision[]
  /** Analyze decision trends over time */
  analyzeTrends(agentId?: string | undefined | null, periodDays?: number | undefined | null): NapiTrendAnalysis
...
// ============================================================================
// Prune Types (Phase 5 - Context Window Management)
// ============================================================================
...
/** Reference to a message part for pruning */
...
/** Plan for pruning tool outputs */
export interface NapiPrunePlan {
  /** Parts to mark as compacted */
  partsToPrune: NapiPartReference[]
...
/** Information about a tool part in a message */
...
/** Information about a message for pruning */
export interface NapiMessageInfo {
  ...
  toolParts: NapiToolPartInfo[]
}

/** Check if token usage exceeds model limits */
...
export declare function computePrunePlan(toolParts: NapiToolPartInfo[], config: NapiPruneConfig): NapiPrunePlan

/** Compute a prune plan with turn-level awareness */
export declare function computePrunePlanWithTurns(messages: NapiMessageInfo[], config: NapiPruneConfig): NapiPrunePlan

/** Create default prune configuration */
export declare function createDefaultPruneConfig(): NapiPruneConfig

// ============================================================================
// Skill Parser Types (Phase 11 - Native YAML Frontmatter Parsing)
// ============================================================================
...
/** Similar decision for retrieval */
...
export interface NapiTrendAnalysis {
  ...
  totalDecisions: number
  /** Success rate before midpoint */
  successRateBefore: number
  /** Success rate after midpoint */
  successRateAfter: number
  /** Confidence before midpoint */
  confidenceBefore: number
  /** Confidence after midpoint */
  confidenceAfter: number
  /** Action type shifts (JSON string) */
...
// Note: chunkText and chunkTextWithConfig are declared above with proper types (NapiChunk[])
...
export declare class ToolRegistryHandle {
  ...
  executeBatch(calls: Array<{tool: string, argsJson: string, callId: string}>): Promise<NapiBatchResult>
}
