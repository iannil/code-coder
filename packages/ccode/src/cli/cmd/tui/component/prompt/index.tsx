...
export function Prompt(props: PromptProps) {
          ...
          const updatedNonTextParts = nonTextParts
            .map((part) => {
              ...
              if (part.type === "file" && part.source && typeof part.source === "object" && "text" in part.source) {
                ...
                virtualText = (part.source as { value: string }).value
              }
  ...
  async function submit() {
    ...
    const allExtmarks = input.extmarks.getAllForTypeId(promptPartTypeId)
    const sortedExtmarks = allExtmarks.sort((a: { start: number }, b: { start: number }) => a.start - b.start)
  ...
  async function pasteImage(file: { filename?: string; content: string; mime: string }) {
    const currentOffset = input.visualCursor.offset
    const extmarkStart = currentOffset
    const count = store.prompt.parts.filter((x: PromptInfo["parts"][number]) => x.type === "file").length
