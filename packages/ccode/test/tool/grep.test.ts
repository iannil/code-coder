...
describe("tool.grep", () => {
  test.skipIf(!rgAvailable)("basic search", async () => {
  ...
  test.skipIf(!rgAvailable)("no matches returns correct output", async () => {
  ...
  test.skipIf(!rgAvailable)("handles CRLF line endings in output", async () => {
